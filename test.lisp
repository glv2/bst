...
(test bst-search-max-value-below
  (is-false (bst-search-max-value-below +bst-empty+ 5))
  (let ((tree (bst-from-sorted-values #(1 2 3 4 5 6 7 8 9))))
    (is-false (bst-search-max-value-below tree 1))
    (is (= 1 (bst-search-max-value-below tree 2)))
    (is (= 2 (bst-search-max-value-below tree 3)))
    (is (= 3 (bst-search-max-value-below tree 4)))
    (is (= 4 (bst-search-max-value-below tree 5)))
    (is (= 5 (bst-search-max-value-below tree 6)))
    (is (= 6 (bst-search-max-value-below tree 7)))
    (is (= 7 (bst-search-max-value-below tree 8)))
    (is (= 8 (bst-search-max-value-below tree 9)))
    (is (= 9 (bst-search-max-value-below tree 10)))
    (is (= 9 (bst-search-max-value-below tree 100))))
  (let* ((*bst-copy-function* #'copy-seq)
         (*bst-equal-p-function* #'string=)
         (*bst-lesser-p-function* #'string<)
         (tree (bst-from-values '("def" "abc" "xyz" "ijk"))))
    (is (bst-equal-p "ijk" (bst-search-max-value-below tree "lmn"))))
  (let* ((*bst-copy-function* #'copy-seq)
         (*bst-equal-p-function* #'equalp)
         (*bst-lesser-p-function* (lambda (x y) (< (length x) (length y))))
         (tree (bst-from-values '((1 2 3 4) (5 5 5) (9 8 7 6 5 4) ()))))
    (multiple-value-bind (value found)
        (bst-search-max-value-below tree '(2 2))
      (is (bst-equal-p nil value))
      (is-true found))))
...
(test bst-search-min-value-above
  (is-false (bst-search-min-value-above +bst-empty+ 5))
  (let ((tree (bst-from-sorted-values #(1 2 3 4 5 6 7 8 9))))
    (is (= 1 (bst-search-min-value-above tree -10)))
    (is (= 1 (bst-search-min-value-above tree 0)))
    (is (= 2 (bst-search-min-value-above tree 1)))
    (is (= 3 (bst-search-min-value-above tree 2)))
    (is (= 4 (bst-search-min-value-above tree 3)))
    (is (= 5 (bst-search-min-value-above tree 4)))
    (is (= 6 (bst-search-min-value-above tree 5)))
    (is (= 7 (bst-search-min-value-above tree 6)))
    (is (= 8 (bst-search-min-value-above tree 7)))
    (is (= 9 (bst-search-min-value-above tree 8)))
    (is-false (bst-search-min-value-above tree 9)))
  (let* ((*bst-copy-function* #'copy-seq)
         (*bst-equal-p-function* #'string=)
         (*bst-lesser-p-function* #'string<)
         (tree (bst-from-values '("def" "abc" "xyz" "ijk"))))
    (is (bst-equal-p "ijk" (bst-search-min-value-above tree "ghi"))))
  (let* ((*bst-copy-function* #'copy-seq)
         (*bst-equal-p-function* #'equalp)
         (*bst-lesser-p-function* (lambda (x y) (< (length x) (length y))))
         (tree (bst-from-values '((1 2 3 4) (5 5 5) (9 8 7 6 5 4) ()))))
    (multiple-value-bind (value found)
        (bst-search-min-value-above tree '(2 2))
      (is (bst-equal-p '(5 5 5) value))
      (is-true found))))
